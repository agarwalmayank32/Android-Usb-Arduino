...
class UsbController {
	...
	private static final String ACTION_USB_PERMISSION = "info.mayankag.USB";

	UsbController(Activity parentActivity, IUsbConnectionHandler connectionHandler, int vid, int pid) {
	...
	private final static String TAG = "USBController";
